...
app.post('/', async (req, res) => {
  try {
    ...
    const response = await openai.createCompletion({
      ...
      max_tokens: 3000, // O número máximo de tokens a serem gerados na conclusão. A maioria dos modelos tem um comprimento de contexto de 2.048 tokens (exceto os modelos mais novos, que suportam 4.096).
